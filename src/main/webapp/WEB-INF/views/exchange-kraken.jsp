...
<head>
  ...
  <style>
    ...
    .exchange-header h1 {
      ...
      margin: 0;
      padding: 0.5rem 1rem;
      background: #584BDD; /* Фиолетовый цвет для Kraken */
      color: #fff;
...
<div class="page-wrapper">
  ...
  <main class="main-content">
    <div class="exchange-header">
      <h1 onclick="window.location.href='https://www.kraken.com'">${exchange}</h1>
    </div>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    nameFilter.value = localStorage.getItem('kraken-nameFilter') || "${filterMode}";
    minPrice.value = localStorage.getItem('kraken-minPrice') || "${minPrice}";
    maxPrice.value = localStorage.getItem('kraken-maxPrice') || "${maxPrice}";
    sortSelect.value = localStorage.getItem('kraken-sort') || "${sort}";
    ...
    function applyFiltersAndSort() {
      ...
      localStorage.setItem('kraken-nameFilter', nameFilter.value);
      localStorage.setItem('kraken-minPrice', minPrice.value);
      localStorage.setItem('kraken-maxPrice', maxPrice.value);
      localStorage.setItem('kraken-sort', sortSelect.value);
    }
