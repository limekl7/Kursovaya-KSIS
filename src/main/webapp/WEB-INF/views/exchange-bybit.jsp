...
<head>
  ...
  <style>
    ...
    .exchange-header h1 {
      ...
      margin: 0;
      padding: 0.5rem 1rem;
      background: #00A3E0; /* Цвет для ByBit */
      color: #fff;
...
<div class="page-wrapper">
  ...
  <main class="main-content">
    <div class="exchange-header">
      <h1 onclick="window.location.href='https://www.bybit.com/trade/spot'">${exchange}</h1>
    </div>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    nameFilter.value = localStorage.getItem('bybit-nameFilter') || "${filterMode}";
    minPrice.value = localStorage.getItem('bybit-minPrice') || "${minPrice}";
    maxPrice.value = localStorage.getItem('bybit-maxPrice') || "${maxPrice}";
    sortSelect.value = localStorage.getItem('bybit-sort') || "${sort}";
    ...
    function applyFiltersAndSort() {
      ...
      localStorage.setItem('bybit-nameFilter', nameFilter.value);
      localStorage.setItem('bybit-minPrice', minPrice.value);
      localStorage.setItem('bybit-maxPrice', maxPrice.value);
      localStorage.setItem('bybit-sort', sortSelect.value);
    }
