...
<head>
  ...
  <style>
    ...
    .exchange-header h1 {
      ...
      margin: 0;
      padding: 0.5rem 1rem;
      background: #A40E2D; /* Тёмно-красный цвет для Bitfinex */
      color: #fff;
...
<div class="page-wrapper">
  ...
  <main class="main-content">
    <div class="exchange-header">
      <h1 onclick="window.location.href='https://www.bitfinex.com'">${exchange}</h1>
    </div>
                ...
                <div class="price-changes">
                  <div class="price-change-wrapper">
                    ...
                    <span class="price-change ${record.priceChange24h >= 0 ? 'positive' : 'negative'}">
                      <fmt:formatNumber value="${record.priceChange24h*100}" type="number" minFractionDigits="2" maxFractionDigits="4"/>%
                    </span>
                  </div>
                </div>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    nameFilter.value = localStorage.getItem('bitfinex-nameFilter') || "${filterMode}";
    minPrice.value = localStorage.getItem('bitfinex-minPrice') || "${minPrice}";
    maxPrice.value = localStorage.getItem('bitfinex-maxPrice') || "${maxPrice}";
    sortSelect.value = localStorage.getItem('bitfinex-sort') || "${sort}";
    ...
    function applyFiltersAndSort() {
      ...
      localStorage.setItem('bitfinex-nameFilter', nameFilter.value);
      localStorage.setItem('bitfinex-minPrice', minPrice.value);
      localStorage.setItem('bitfinex-maxPrice', maxPrice.value);
      localStorage.setItem('bitfinex-sort', sortSelect.value);
    }
