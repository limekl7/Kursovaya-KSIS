...
<head>
  ...
  <style>
    ...
    .exchange-header h1 {
      ...
      margin: 0;
      padding: 0.5rem 1rem;
      background: #F0B90B; /* Золотисто-жёлтый цвет для Binance */
      color: #fff;
...
<div class="page-wrapper">
  ...
  <main class="main-content">
    <div class="exchange-header">
      <h1 onclick="window.location.href='https://www.binance.com/en/trade'">${exchange}</h1>
    </div>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    nameFilter.value = localStorage.getItem('binance-nameFilter') || "${filterMode}";
    minPrice.value = localStorage.getItem('binance-minPrice') || "${minPrice}";
    maxPrice.value = localStorage.getItem('binance-maxPrice') || "${maxPrice}";
    sortSelect.value = localStorage.getItem('binance-sort') || "${sort}";
    ...
    function applyFiltersAndSort() {
      ...
      localStorage.setItem('binance-nameFilter', nameFilter.value);
      localStorage.setItem('binance-minPrice', minPrice.value);
      localStorage.setItem('binance-maxPrice', maxPrice.value);
      localStorage.setItem('binance-sort', sortSelect.value);
    }
